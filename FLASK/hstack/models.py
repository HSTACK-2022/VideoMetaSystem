...
class Keyword(db.Model):
    ...
    percent = db.Column(db.Float, nullable=False, server_default=db.FetchedValue())
...
class ScriptSearch(db.Model):
    ...
    id = db.Column(db.ForeignKey('videopath.id'), primary_key=True, nullable=False)
    log = db.Column(db.String(50), primary_key=True, nullable=False)
...
class Videopath(db.Model):
    ...
    logAddr = db.Column(db.String(45))
...
class Metadatum(Videopath):
    ...
    category_percent = db.Column(db.String(30), nullable=False, server_default=db.FetchedValue())
