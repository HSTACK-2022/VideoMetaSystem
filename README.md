...
<br/>
   ...
   <img src=./report/img/flaskArch1.jpg alt="flaskArch1"/>
...
<br/>
   ...
   <img src=./report/img/flaskArch2.jpg alt="flaskArch2"/>

<br/>
   
<b>웹 서버 애플리케이션의 3가지 모듈의 기능은 다음과 같다. </b> 

<br/>

<details>
<summary>메타데이터 생성 모듈</summary>
<div markdown="1">       
...
&nbsp; 1의 시스템 구성 중 웹 클라이언트 애플리케이션의 구조는 그림 3과 같다. 웹 클라이언트 애플리케이션은 크게 4가지의 모듈들로 구성되어 있다. 모듈들은 파일 시스템의 자바 스크립트 코드들로 동작한다. 

<br/>

   <img src=./report/img/flaskArch3.jpg alt="flaskArch3" width = "600"/>

<br/>

<details>
<summary>영상 내부 검색 모듈</summary>
<div markdown="1">       
...
<details>
<summary>.zip, .ppt 다운로드 모듈</summary>
<div markdown="1">       
